...
class ThreadModel {
  ...
  // --- FUNGSI PENYELAMAT: Mengubah apapun jadi int (Anti Null) ---
  ...
  factory ThreadModel.fromJson(Map<String, dynamic> json) {
    ...
    return ThreadModel(
      ...
      // Pakai _toInt() disini agar tidak pernah crash
...
//       threadUpvote: json['thread_upvote'] ?? 0,
//       threadDownvote: json['thread_downvote'] ?? 0,
//       replyCount: json['reply_count'] ?? 0,
//       upvotes: json['thread_upvote'] ?? 0,
//       downvotes: json['thread_downvote'] ?? 0,
//       userVote: 0
//     );
//   }
//
